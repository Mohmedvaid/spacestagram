...
const Card = ({ photo, addNewLike, removeLike, isLikedImage }) => {
	...
	return (
		<div className="m-1">
			<div className="card">
				<img className="card-img-top img-fluid" src={imgSrc} alt={description} />
				<div className="card-body">
					...
					<div className="d-flex justify-content-between my-1">
						...
						<a className="likeBtn m-1 disable-text-selection" onClick={() => toggleLike()}>
							{/* like icon */}
							<span>
								{' '}
								{isLiked ? (
						...
						<a className="copyBtn m-1 cursor-pointer" onClick={() => copyImageUrl()}>
							Copy Image Link
						</a>
